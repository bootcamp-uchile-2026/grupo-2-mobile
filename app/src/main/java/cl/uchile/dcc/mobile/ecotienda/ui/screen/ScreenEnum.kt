...
enum class ScreenEnum (
    ...
    LOGIN(showTopBar = false, showBottomBar = false, title = "Ingreso de Usuarios",
        route = "Login"),

    CART(showTopBar = false, showBottomBar = false, title = "Carrito",
        route = "Carrito"),

    SEARCH(showTopBar = false, showBottomBar = false, title = "Búsqueda",
        route = "Buscador");
}
